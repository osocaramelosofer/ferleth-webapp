export default {
  'es-AR': {
    formTitle: 'Características de Estola',
    stoleType: 'Material de estola',
    stoleTypePlaceholder: 'Por favor seleccione el material de estola',
    stoleColor: 'Color de Estola',
  ...
  'en-US': {
    ...
    stoleType: 'Stole Material',
    stoleTypePlaceholder: 'Please select the stole material',
